...
TypeOK ==
          /\ \A i \in DOMAINtowers : /\ towers[i] \in Nat
...
Move(from, to, disk) ==
        ...
        /\ towers' = [towersEXCEPT![from]=towers[from] - disk,\* Remaining tower does not change
...
(***************************************************************************)
Next ==
        \E d \in SetOfPowerOfTwo(D) : \E idx1 , idx2 : /\ idx1 # idx2
