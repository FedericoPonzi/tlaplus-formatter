...
class MainTest {
    ...
    void testMainWithValidInput() throws Exception {
        ...
        assertTrue(outContent.toString().contains("Formatted output written to:"), "Console should indicate successful formatting");
        assertTrue(errContent.toString().isEmpty(), "No error messages should be printed");
    ...
    void testMainWithInvalidArguments() {
        ...
        assertTrue(errContent.toString().contains("Please provide one or two file paths"), "Error message should be printed for invalid arguments");
    ...
    void testMainWithNonExistentInputFile() {
        ...
        // Check if the error message is printed
        assertTrue(errContent.toString().contains("Input file does not exist"), "Error message should be printed for non-existent input file");
    ...
    void testMainWithVerbosityOption() throws Exception {
        ...
        assertTrue(outContent.toString().contains("DEBUG"), "Debug messages should be printed with verbosity option");
